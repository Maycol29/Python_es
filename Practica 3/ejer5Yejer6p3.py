...
# def escribirArchivoUbi(datos ):
#     with open("coordenadas.txt","w")as archivo:
#         json.dump(datos,archivo)

# def escribirArchivoColors(datos ):
#     with open("colores.txt","w")as archivo:
#         json.dump(datos,archivo)

def leerArchivoUbi():
    with open("coordenadas.txt","r")as archivo:
        datos=json.load(archivo)
        return datos

def leerArchivoColors():
    with open("colores.txt","r")as archivo:
        datos=json.load(archivo)
        return datos
...
escribirArchivoColors(colores)
escribirArchivoUbi(coordenadas)
